...
class Setting(models.Model):
    ...
    nearby_image = models.ImageField(upload_to='logo/',blank=True,null=True)
    nearby_title = models.CharField(max_length=150,blank=True,null=True)
    nearby_description = models.CharField(max_length=1500,blank=True,null=True)
    footer_title = models.CharField(max_length=150,)
    footer_description = models.CharField(max_length=1500,blank=True,null=True)
    footer_copyright = models.CharField(max_length=150,blank=True,null=True)
